                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('event_registration_access')
                                        <a class="dropdown-item" href="{{ route('frontend.event-registrations.index') }}">
                                            {{ trans('cruds.eventRegistration.title') }}
                                        </a>
                                    @endcan
                                    @can('event_attendance_access')
                                        <a class="dropdown-item" href="{{ route('frontend.event-attendances.index') }}">
                                            {{ trans('cruds.eventAttendance.title') }}
                                        </a>
                                    @endcan
                                    @can('event_feedback_access')
                                        <a class="dropdown-item" href="{{ route('frontend.event-feedbacks.index') }}">
                                    ...
                                    @can('sponsorship_tracking_access')
                                        <a class="dropdown-item" href="{{ route('frontend.sponsorship-trackings.index') }}">
                                    ...
                                    @can('sponsorship_type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.sponsorship-types.index') }}">
                                            {{ trans('cruds.sponsorshipType.title') }}
                                        </a>
                                    @endcan
                                    @can('event_type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.event-types.index') }}">
                                            {{ trans('cruds.eventType.title') }}
                                        </a>
                                    @endcan
                                    @can('event_setting_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.event-settings.index') }}">
