        ...
        <form method="POST" action="{{ route("admin.event-settings.update", [$eventSetting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('event_reminder_sms') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="event_reminder_sms" id="event_reminder_sms" value="1" {{ $eventSetting->event_reminder_sms || old('event_reminder_sms', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_remind_sms') ? 'is-invalid' : '' }}" type="text" name="event_remind_sms" id="event_remind_sms" value="{{ old('event_remind_sms', $eventSetting->event_remind_sms) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('event_attend_form_sms') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="event_attend_form_sms" id="event_attend_form_sms" value="1" {{ $eventSetting->event_attend_form_sms || old('event_attend_form_sms', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_attend_form_filling_message') ? 'is-invalid' : '' }}" type="text" name="event_attend_form_filling_message" id="event_attend_form_filling_message" value="{{ old('event_attend_form_filling_message', $eventSetting->event_attend_form_filling_message) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('event_attend_thank_sms') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="event_attend_thank_sms" id="event_attend_thank_sms" value="1" {{ $eventSetting->event_attend_thank_sms || old('event_attend_thank_sms', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_attend_thank_message') ? 'is-invalid' : '' }}" type="text" name="event_attend_thank_message" id="event_attend_thank_message" value="{{ old('event_attend_thank_message', $eventSetting->event_attend_thank_message) }}">
