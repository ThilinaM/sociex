...
@can('sponsorship_tracking_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.sponsorship-trackings.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-SponsorshipTracking">
            <thead>
                <tr>
                    <th width="10">
...
@can('sponsorship_tracking_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.sponsorship-trackings.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.sponsorship-trackings.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'name', name: 'name' },
{ data: 'logo', name: 'logo', sortable: false, searchable: false },
{ data: 'sponsorship_type_name', name: 'sponsorship_type.name' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-SponsorshipTracking').DataTable(dtOverrideGlobals);
