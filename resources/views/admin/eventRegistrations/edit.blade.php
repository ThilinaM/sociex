    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.event-registrations.update", [$eventRegistration->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $eventRegistration->first_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $eventRegistration->last_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $eventRegistration->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile', $eventRegistration->mobile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('whatsup') ? 'is-invalid' : '' }}" type="text" name="whatsup" id="whatsup" value="{{ old('whatsup', $eventRegistration->whatsup) }}">
