                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.events.update", [$event->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="start_time" id="start_time" value="{{ old('start_time', $event->start_time) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="end_time" id="end_time" value="{{ old('end_time', $event->end_time) }}">
                        ...
                        <div class="form-group">
                            <label for="cover_image">{{ trans('cruds.event.fields.cover_image') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.event.fields.cover_image_helper') }}</span>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="short_description" id="short_description" value="{{ old('short_description', $event->short_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="long_description" id="long_description">{!! old('long_description', $event->long_description) !!}</textarea>
                        ...
                        <div class="form-group">
                            <label for="event_type_id">{{ trans('cruds.event.fields.event_type') }}</label>
                            <select class="form-control select2" name="event_type_id" id="event_type_id">
                                @foreach($event_types as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('event_type_id') ? old('event_type_id') : $event->event_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
...
@if(isset($event) && $event->cover_image)
      var file = {!! json_encode($event->cover_image) !!}
