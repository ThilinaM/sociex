            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="whatsup">{{ trans('cruds.user.fields.whatsup') }}</label>
                            <input class="form-control" type="text" name="whatsup" id="whatsup" value="{{ old('whatsup', $user->whatsup) }}">
                            @if($errors->has('whatsup'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('whatsup') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.user.fields.whatsup_helper') }}</span>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="organization" id="organization" value="{{ old('organization', $user->organization) }}">
