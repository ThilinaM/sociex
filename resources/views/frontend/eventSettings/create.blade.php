    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.event-settings.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="event_reminder_sms" id="event_reminder_sms" value="1" {{ old('event_reminder_sms', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="event_remind_sms" id="event_remind_sms" value="{{ old('event_remind_sms', '') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="event_attend_form_sms" id="event_attend_form_sms" value="1" {{ old('event_attend_form_sms', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="event_attend_form_filling_message" id="event_attend_form_filling_message" value="{{ old('event_attend_form_filling_message', '') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="event_attend_thank_sms" id="event_attend_thank_sms" value="1" {{ old('event_attend_thank_sms', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="event_attend_thank_message" id="event_attend_thank_message" value="{{ old('event_attend_thank_message', '') }}">
