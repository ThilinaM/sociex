...
class EventRegistrationApiController extends Controller
{
    public function index()
    {
        ...
        return new EventRegistrationResource(EventRegistration::with(['event', 'created_by'])->get());
    }
    ...
    public function show(EventRegistration $eventRegistration)
    {
        ...
        return new EventRegistrationResource($eventRegistration->load(['event', 'created_by']));
    }
